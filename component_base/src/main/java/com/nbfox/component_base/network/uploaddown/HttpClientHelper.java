...
//            client.sslSocketFactory(HttpConfig.getSSLSocketFactory(),HttpConfig.getTrustManager());
//            client.hostnameVerifier(HttpConfig.getHostnameVerifier());
//        }
        client.readTimeout(HttpConfig.DEFAULT_READ_TIMEOUT, TimeUnit.SECONDS);
        client.writeTimeout(HttpConfig.DEFAULT_WRITE_TIMEOUT, TimeUnit.SECONDS);
        client.connectTimeout(HttpConfig.DEFAULT_CONNECT_TIME_OUT, TimeUnit.SECONDS);
        client.connectionPool(HttpConfig.getConnectionPoolSize());
