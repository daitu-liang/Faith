package com.nbfox.component_base.widget;
...
public class ActionBar extends RelativeLayout {
     ...
     * 字体颜色
     */
    private int leftTextColor = R.color.text_blue;
    private int centerTextColor = R.color.text_blue;
    private int rightTextColor = R.color.text_blue;
    /**
     * 字体大小
     */
    ...
    public void showBackImg(boolean show) {
        if (show) {
            setLeftIcon(R.drawable.base_ic_back, new OnClickListener() {
                @Override
    ...
    public ImageView getImageView() {
        ...
        iv.setLayoutParams(new LayoutParams(DensityUtil.dp2px(getContext(), 25), DensityUtil.dp2px(getContext(), 25)));
        return iv;
